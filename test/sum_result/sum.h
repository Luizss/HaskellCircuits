...
sc_lv<2> cond;
sc_lv<32> s__destroy;
sc_fifo<sc_lv<31> > __fifo__sum__rec__expr__2__2__in__a;
sc_fifo<sc_lv<32> > __fifo__sum__rec__expr__2__2__in__now__1__s;
sc_lv<31> __fifo__sum__rec__expr__2__2__out__aux;
sc_fifo<sc_lv<31> > __fifo__sum__rec__expr__2__2__out;

void proc();
SC_CTOR(sum) : const_dec_11("const_dec_11"), const_dec_01("const_dec_01"), sli_1_31_1("sli_1_31_1"), add1("add1"), sli_0_0_1("sli_0_0_1"), equ1("equ1") {

add1.in2(__fifo__sum__rec__expr__2__2__in__a);
sli_1_31_1.in1(__fifo__sum__rec__expr__2__2__in__now__1__s);
add1.in1(__fifo__2);
sli_1_31_1.out(__fifo__2);
add1.out(__fifo__sum__rec__expr__2__2__out);
const_dec_11.out(__fifo__sum__cond__2__out);
...
cond = (__fifo__sum__cond__2__out__aux, __fifo__sum__cond__1__out__aux);
if (cond[0]==1) {
out.write(a__aux);
...
__fifo__sum__rec__expr__2__2__in__a.write(a__aux);
__fifo__sum__rec__expr__2__2__in__now__1__s.write(s__now__1);
__fifo__sum__rec__expr__2__2__out__aux = __fifo__sum__rec__expr__2__2__out.read();
a__aux = __fifo__sum__rec__expr__2__2__out__aux;
